...
class assignmentOne {
	 ...
	 * @param args  Warning: optional args must be specified in sequence, i.e., cannot specify numRandomPoints
	 * 				without specifying m. Program does little to no input validation because it's due < 24hours.
	 * 				1. infile <required> - input file full of points. One point per line,
	 * 					x and y coordinates separated by a space. WARNING: program does not do
	 * 					file input validation.
	 * 				2. outfile <optional> - path to file to write random points to. Works in
	 * 					conjunction with numRandomPoints 
	 * 				3. m <optional> - per D-ii, calculate the closest m pairs. Defaults to 1.
	 * 				4. numRandomPoints <optional> - if this arg is present, Main will call the
	 * 					generateRandomPoints method to generate the specified number of points.
	 * 					Must be specified in tandem with outRandomPoints below.
	 */
